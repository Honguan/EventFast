...
最新本機候選：`artifacts/release-20260823-12/win-x64/EventFast.exe`

SHA256：`25a7366989171ac5cd99e03d320174ca8c71942b44ac4b95c8734a4fc6922810`
...
- [x] 三次全新 bundle extraction 冷啟動 726／640／671 ms，中位數 671 ms（門檻 < 1 秒）
...
- [x] 500 次 native query/message 循環（handle -3、private memory +15.2 MB，門檻 +10／+32 MB）
- [x] SHA256 產生完成
...
- [x] UI 驗證（命令列自動查詢、雙 Channel 32 筆／105 ms；候選檔 Enter、雙擊、Esc、Message/XML）
