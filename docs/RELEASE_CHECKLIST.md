...
最新本機候選：`artifacts/release-20260823-10/win-x64/EventFast.exe`

SHA256：`241f9d563176fb2a7b9bd5e72e0ebde23bd98dd57a6fd145432f372b3e34ebac`
...
- [x] 三次全新 bundle extraction 冷啟動 834／754／721 ms，中位數 754 ms（門檻 < 1 秒）
...
- [x] 500 次 native query/message 循環（handle -2、private memory +16.4 MB，門檻 +10／+32 MB）
- [x] SHA256 產生完成
