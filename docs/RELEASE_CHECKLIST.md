...
最新本機候選：`artifacts/release-20260823-11/win-x64/EventFast.exe`

SHA256：`3d50e09a66cbb53921b5fd16b678fd5798726c74f13c7755d44a625261c3c17c`
...
- [x] 三次全新 bundle extraction 冷啟動 865／785／742 ms，中位數 785 ms（門檻 < 1 秒）
...
- [x] 500 次 native query/message 循環（handle -3、private memory +15.0 MB，門檻 +10／+32 MB）
- [x] SHA256 產生完成
