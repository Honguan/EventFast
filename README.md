...
Download `EventFast-v1.0.2-win-x64.exe` from the [EventFast v1.0.2 release](https://github.com/Honguan/EventFast/releases/tag/v1.0.2). It supports Windows 10 and 11 x64, is self-contained, and requires neither an installer nor a separate .NET runtime.
